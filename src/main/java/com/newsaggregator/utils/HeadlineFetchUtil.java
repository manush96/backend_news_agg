...
public class HeadlineFetchUtil {
	...
	public  List<NewsSnippet> fetchBusniess(String country) throws JSONException
	{
		JSONObject jsonObj = null;

		final String uri = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=65c90f5e609b434ab94f2d5e572dd67e";
